...
BrowserWorkerProvider.prototype.heartbeatInterval = 5000; // 5 seconds is a long time to block the ui thread.
...
BrowserWorkerProvider.prototype.startHeartbeats = function(){
	if(this.heartbeatInterval){
		...
		// the transport timing would result in an unresponsive state. A.k.a. Nyquist frequency.

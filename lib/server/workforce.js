...
var create = exports.create = function(workerConfig, options){
	var workforce = new Workforce(workerConfig, options.runResource);
	options = options || {};
...
var IFRAME_SCRIPT = '<script>' +
						'var getParam=function(a){a=a.replace(/[\\[]/,"\\\\[").replace(/[\\]]/,"\\\\]");a=RegExp("[\\\\?&]"+a+"=([^&#]*)").exec(window.location.search);return null==a?"":decodeURIComponent(a[1].replace(/\\+/g," "))};' +
						'window.queenSocket = window.parent.iframeSockets[getParam("queenSocketId")];' +
						'window.alert = function(){};' + 
						'window.confirm = function(){return false;};' +
						'window.prompt = function(){return null;};' +
					'</script>';

var Workforce = exports.Workforce = function(workerConfig, runResource){
	...
	if(runResource){
		runResource = runResource.replace(/(<head.*>)/,'$1' + IFRAME_SCRIPT);
...
var getApi = function(workforce){
	...
	api.runResource = workforce.runResource;
